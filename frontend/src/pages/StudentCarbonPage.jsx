    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden" style={{ height: 260 }}>
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Carbon Footprinting</h1>
            <p className="text-slate-300">Calculate and track carbon emissions for your materials</p>
          </div>
          <button
          ...
          <div className="md:col-span-2">
            {!selectedBom ? (
              ...
              <div className="space-y-6">
                ...
                {/* Carbon Calculation */}
                {result && (
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg shadow p-8 border-2 border-green-200">
                    <div className="flex items-center mb-4">
                      <h3 className="text-3xl font-bold text-green-700">Carbon Footprint Analysis</h3>
                    </div>
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Estimated Carbon Footprint</p>
                        <p className="text-5xl font-bold text-green-600">{result.carbonFootprint.toFixed(2)}</p>
                        <p className="text-sm text-gray-600 mt-1">kg CO₂e</p>
                      </div>
                      <div className="bg-white rounded p-4 text-sm text-gray-700">
                        ...
                        <ul className="list-disc list-inside mt-2 space-y-1">
                          ...
                          <li>Carbon factor: 1.5 kg CO₂e per unit</li>
                        </ul>
                      </div>
                    </div>
                  </div>
