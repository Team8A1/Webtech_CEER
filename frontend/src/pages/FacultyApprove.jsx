  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold">Guide Approval Queue</h2>
      ...
      <div className="space-y-4">
        ...
        {boms.map(b => (
          <div key={b.id} className="p-4 bg-white rounded shadow flex justify-between items-center">
            ...
            <div>
              {!b.guideApproved && <button onClick={() => approve(b.id)} className="bg-gray-900 text-white px-3 py-1 rounded">Approve</button>}
            </div>
          </div>
        ))}
      </div>
